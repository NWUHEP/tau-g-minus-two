...
// $Rev:: 269                         $: revision of last commit
// $Author:: butter                   $: author of last commit
// $Date:: 2016-07-08 15:16:38 +0000 #$: date of last commit
//
// Description:
//
//
...
namespace starlightConstants
{
	...
	public:
		...
		int _daughter1[30];
		int _daughter2[30];
                double ppx1[30],ppy1[30],ppz1[30];
	        double ppx2[30],ppy2[30],ppz2[30];
	        double px1[30],py1[30],pz1[30];
	        double px2[30],py2[30],pz2[30];
